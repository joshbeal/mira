...
use crate::traits::BDCurveAffine;
...
pub trait SpecialSoundnessVerifier<C: BDCurveAffine, RO: ROTrait<C::Base>> {
    fn sps_verify(&self, ro_nark: &mut RO) -> Result<(), Error>;
}

impl<C: BDCurveAffine, RO: ROTrait<C::Base>> SpecialSoundnessVerifier<C, RO> for PlonkInstance<C> {
    fn sps_verify(&self, ro_nark: &mut RO) -> Result<(), Error> {
