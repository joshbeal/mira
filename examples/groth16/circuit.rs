...
pub struct Groth16AggregateCircuit<F>
where
...
impl<F> Default for Groth16AggregateCircuit<F>
where
    F: PrimeFieldBits + serde::Serialize + FromUniformBytes<64>,
{
    fn default() -> Self {
...
impl<F> Groth16AggregateCircuit<F>
where
    F: PrimeFieldBits + serde::Serialize + FromUniformBytes<64>,
{
...
impl<F> StepCircuit<1, F> for Groth16AggregateCircuit<F>
where
    F: PrimeFieldBits + serde::Serialize + FromUniformBytes<64>,
{
...
impl<F> Circuit<F> for Groth16AggregateCircuit<F>
where
    F: PrimeFieldBits + serde::Serialize + FromUniformBytes<64>,
{
